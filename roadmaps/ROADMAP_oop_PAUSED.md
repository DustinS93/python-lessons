...
> **PAUSED (Session 30, 2026-07-02).** Parked mid-flight after steps 1–2 (class,
> `__init__`, `self`, list-as-attribute). Dustin understands OOP fundamentally and
> chose to pivot to **scripting** (see the active `ROADMAP.md`). Resume here — next
> unchecked box is Step 3, methods that change the object — whenever he asks to
> return to classes.
